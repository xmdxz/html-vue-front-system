...
!function (global, factory) {
    ...
    "use strict";
    var msgWrapper = c({className: "dream-msg-stage"});
    ...
    var initArgs = {msg: "", duration: 2000, showClose: false};
    var Dreamer = {
        info: function info() {
    ...
    function createMsgEl(args) {
        var type = args.type, duration = args.duration, msg = args.msg, showClose = args.showClose,
        ...
        var el = c({className: "dream-msg-wrapper"}, [c({className: "dream-msg dream-msg-fade-in " + type}, [c({className: "dream-msg-icon"}, iconObj[type]), c({className: "dream-msg-content"}, msg), c({
        ...
        if (anm) {
            css(anm, {animation: "dream-msg_" + type + " " + duration + "ms linear"});
        ...
        css(el, {height: el.offsetHeight + "px"});
        setTimeout(function () {
...
function errorSound() {
    ...
    audio.setAttribute('src', 'https://cdn.jsdelivr.net/gh/iGaoWei/Dream-Msg/lib/wav/tip.mp3');
